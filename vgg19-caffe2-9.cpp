...
#include <iostream>
#include <fstream>
#include "vgg19-caffe2-9.h"
SymbolTableEntry symbolTableEntry_vgg19-caffe2-9[2]={{"data_0",0,150528,'1'},{"prob_1",602112,1000,'1'}};
BundleConfig vgg19-caffe2-9_config = {143708256, 606112, 0, 64, 2, symbolTableEntry_vgg19-caffe2-9};
namespace namespace_vgg19-caffe2-9 {
...
using namespace namespace_vgg19-caffe2-9;
extern VTACommandHandle vtaCmdH;

void vgg19-caffe2-9_load_module(uint8_t *constantWeight){
...
void vgg19-caffe2-9_destroy_module(){
...
int vgg19-caffe2-9(uint8_t *constantWeight, uint8_t *mutableWeight, uint8_t *activations){
